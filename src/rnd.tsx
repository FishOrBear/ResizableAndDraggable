...
export interface Props
{
    ...
    size?: Size;
    resizeGrid?: Grid;
    resizeCatchSize?: number;
    resizeCatchInbreak?: number;
    bounds?: string;
...
export class Rnd extends React.Component<Props, State> {
    ...
    {
        return (this.resizable && this.resizable.resizable) as HTMLElement;
    }
        ...
        return (
            ...
            >
                <Resizable
                    ...
                    catchSize={this.props.resizeCatchSize}
                    catchInbreak={this.props.resizeCatchInbreak}
                    ...
                    lockAspectRatioExtraWidth={this.props.lockAspectRatioExtraWidth as number}
                    lockAspectRatioExtraHeight={this.props.lockAspectRatioExtraHeight as number}
